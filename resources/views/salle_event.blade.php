...
@endif
                   ...
                   <form action="" method="post" role="form" name="Salle" class="contactForm" action="/salle_event" enctype="multipart/form-data">
            ...
            <div class="form-row">
             ...
             <input type="file" id="photo" name="photo" class="form-control" multiple></myHero>
                     </div><br/>
