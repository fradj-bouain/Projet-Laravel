    ...
    <div class="login-form">
      <div class="sign-in-htm">
        <div class="group">
          ...
          <input id="user" type="text"  class="input{{ $errors->has('email') ? ' is-invalid' : '' }}"  value="{{ old('email') }}" required autofocus>
        ...
        <div class="group">
          ...
          <input id="password" type="password" class="input {{ $errors->has('password') ? ' is-invalid' : '' }}" data-type="password" required>
        ...
        <div class="group">
          <a href="/admi"><input type="submit" class="button" value="{{ __('Login') }}"></a>
...
<!--==========================
    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <div class="row">
           <button type="button" class="btn btn-primary btn-lg btn-block" style="margin-bottom: 20px">SALLE</button>
        </div>
         ...
         @foreach($salles as $salle)
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="{{ Storage::disk('local')->url($salle ->photo) }}" class="img-fluid" alt="">
                
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="#">{{$salle -> name}}</a></h4>
